...
@property (nonatomic, assign) NSInteger pieChartIndex;
...
- (void)drawRect:(CGRect)rect {
    ...
    [info_ drawInRect:r withFont:[UIFont systemFontOfSize:kSGInfoAlert_fontSize] lineBreakMode:NSLineBreakByCharWrapping];
}
...
+ (void)showInfo:(NSString *)info 
  ...
  withHorizontal:(float)width {
    ...
    alert.center = CGPointMake(view.center.x * width, view.frame.size.height * height);
    alert.alpha = 0;
